...
int main() {
	...
	Shader myShader("PROJECT_LOC/Desktop/SlenderProject/shaders/vsCube.txt", "C:/Users/vitor.patricio/Documents/Codes/Desafio OpenGl/cg-internship-test-master/src/fsCube.txt");
